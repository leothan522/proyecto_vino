    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-5 ftco-animate">
                <a href="{{ asset('vendor/liquorstore/images/prod-1.jpg') }}" class="image-popup prod-img-bg">
                    <img src="{{ asset('vendor/liquorstore/images/prod-1.jpg') }}" class="img-fluid" alt="Colorlib Template">
                </a>
            </div>
            ...
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <div class="rating d-flex">
                    <p class="text-left mr-4">
                        <a href="#" class="mr-2">Juan German Roscio</a>
                    </p>
                    <p class="text-left">
                ...
                {{--Botones del Carrito--}}
                <p>
                    <a href="{{ route('web.cart') }}" class="btn btn-primary py-3 px-5 mr-2 mt-2">Añadir al Carrito</a>
                    <a href="{{ route('web.cart') }}" class="btn btn-primary py-3 px-5 mt-2">Comprar Ahora</a>
                </p>
                    ...
                    <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-day-3-tab">
                        <div class="row p-4">
                            <div class="col-md-7">
                                ...
                                <div class="review">
                                    <div class="user-img"
                                         style="background-image: url({{ asset('vendor/liquorstore/images/person_1.jpg') }})"></div>
                                    <div class="desc">
                                        <h4>
                                ...
                                <div class="review">
                                    <div class="user-img"
                                         style="background-image: url({{ asset('vendor/liquorstore/images/person_2.jpg') }})"></div>
                                    <div class="desc">
                                        <h4>
                                            <span class="text-left">Jacob Webb</span>
                                            <span class="text-right">25 April 2020</span>
                                ...
                                <div class="review">
                                    <div class="user-img"
                                         style="background-image: url({{ asset('vendor/liquorstore/images/person_3.jpg') }})"></div>
                                    <div class="desc">
                                        <h4>
                                            <span class="text-left">Jacob Webb</span>
                                            <span class="text-right">25 April 2020</span>
